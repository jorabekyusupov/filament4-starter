...
return [
    ...
    */
    'resource' => [
        'class' => \Modules\ActivityLog\Filament\Resources\ActivityLogs\ActivityLogResource::class,
        'group' => null, // null uses default resource group
        'sort' => null,
    ...
    */
    'pages' => [
        'user_activities' => [
            'enabled' => true,
            'class' => \Modules\ActivityLog\Filament\Pages\UserActivitiesPage::class,
