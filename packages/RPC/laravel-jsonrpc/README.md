...
$jsonRpcServer->onException(
    ...
    function (SomeExceptionClass $e, jsonrpc\src\Server\Request $request = null) {
        $message = "Some Message";
        $code = -32099;
        return jsonrpc\src\Server\RequestResponse::constructErrorResponse($request ? $request->getId() : null, $message, $code);
    }
);

$jsonRpcServer->onException(
    \Throwable::class, // catch-all
    function (\Throwable $e, jsonrpc\src\Server\Request $request = null) {
