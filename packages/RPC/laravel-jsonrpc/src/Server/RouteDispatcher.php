...
use RPC\laraveluse RPC\laraveluse jsonrpc\src\Contract\RouteDispatcherInterface;
use RPC\laraveluse RPC\laraveluse RPC\laraveluse RPC\laraveluse RPC\laraveluse RPC\laraveluse Upgate\LaravelJsonRpc\Contract\RouteInterface;
use Upgate\LaravelJsonRpc\Exception\InternalErrorException;
use jsonrpc\src\Exception\InvalidParamsException;
use jsonrpc\src\Exception\ValidationFailedException;
...
final class RouteDispatcher implements RouteDispatcherInterface
{
    ...
    /**
     * @param string|null $controllerNamespace
     * @return jsonrpc\src\Contract\RouteDispatcherInterface
     */
