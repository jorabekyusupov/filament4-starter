...
use RPC\laraveluse RPC\laraveluse RPC\laraveluse RPC\laraveluse Upgate\LaravelJsonRpc\Contract\RequestFactoryInterface as RequestFactoryContract;
use jsonrpc\src\Contract\RequestInterface;
use jsonrpc\src\Exception\BadRequestException;
...
class RequestFactory implements RequestFactoryContract
{
     ...
     * @return jsonrpc\src\Contract\RequestInterface
     */
