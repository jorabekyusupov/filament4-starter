...
use jsonrpc\src\Server\MiddlewareAliasRegistry;
use jsonrpc\src\Server\MiddlewarePipelineDispatcher;
use jsonrpc\src\Contract\MiddlewaresConfigurationInterface;
use jsonrpc\src\Server\MiddlewaresCollection;
...
class MiddlewareDispatcherTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testNoMiddlewares()
    {
        ...
        /** @var jsonrpc\src\Contract\MiddlewaresConfigurationInterface $middlewares */
