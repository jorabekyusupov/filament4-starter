...
use RPC\laraveluse RPC\laraveluse RPC\laraveluse Upgate\LaravelJsonRpc\Contract\RequestFactoryInterface;
...
final class ServerFactory
{
    ...
    /**
     * @var jsonrpc\src\Contract\MiddlewareDispatcherInterface|null
     */
