...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::create($tableNames['permissions'], static function (Blueprint $table) {
            ...
            $table->unsignedInteger('group_sort')->default(0)->after('translatable');
            $table->unsignedInteger('module_sort')->default(0)->after('group_sort');
            $table->unsignedInteger('sort')->default(0)->after('module_sort');
            $table->timestamps();
