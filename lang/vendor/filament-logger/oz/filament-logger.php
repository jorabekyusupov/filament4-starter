...
return [
    ...
    */
    ...
    'nav.log.label' => 'Faoliyat jurnali',
    'nav.log.icon' => 'heroicon-o-clipboard-document-list',
    'resource.label.log' => 'Faoliyat jurnali',
    'resource.label.logs' => 'Faoliyat jurnallari',
